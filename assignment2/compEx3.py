...
if __name__=="__main__":
    ...
    keypoints2, descriptors2 = sift.detectAndCompute(gray_im1, None)
    ...
    x2 = np.array([[keypoints2[match.queryIdx].pt[0], keypoints1[match.queryIdx].pt[1]] for match in matches])
